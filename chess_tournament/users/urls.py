...
urlpatterns = [
    ...
    path('home/chess_players/follow/<int:user_id>/', ChessPlayerFollowView.as_view(), name='follow'),
    path('home/chess_players/unfollow/<int:user_id>/', ChessPlayerUnfollowView.as_view(), name='unfollow'),
]
